        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopCode = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BakiInvoiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BakiInvoices", x => x.BakiInvoiceId);
                    table.ForeignKey(
                        name: "FK_BakiInvoices_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BakiInvoices_Shops_ShopId",
                        column: x => x.ShopId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_POSTransactions", x => x.POSTransactionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_POSTransactions_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "ShopId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopCustomers", x => new { x.ShopId, x.CustomerId });
                    table.ForeignKey(
                        name: "FK_ShopCustomers_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BakiId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BakiRecords", x => x.BakiId);
                    table.ForeignKey(
                        name: "FK_BakiRecords_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BakiRecords_POSTransactions_POSTransactionId",
                        column: x => x.POSTransactionId,
                        principalTable: "POSTransactions",
                        principalColumn: "POSTransactionId");
                    table.ForeignKey(
                        name: "FK_BakiRecords_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "ShopId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    POSTransactionItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_POSTransactionItems", x => x.POSTransactionItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "BakiInvoiceItems",
                columns: table => new
                {
                    BakiInvoiceItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BakiInvoiceItems", x => x.BakiInvoiceItemId);
                    table.ForeignKey(
                        name: "FK_BakiInvoiceItems_BakiInvoices_BakiInvoiceId",
                        column: x => x.BakiInvoiceId,
                        principalTable: "BakiInvoices",
                        principalColumn: "BakiInvoiceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BakiInvoiceItems_BakiRecords_BakiId",
                        column: x => x.BakiId,
                        principalTable: "BakiRecords",
                        principalColumn: "BakiId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BakiInvoiceItems_BakiId",
                table: "BakiInvoiceItems",
                column: "BakiId");

            migrationBuilder.CreateIndex(
                name: "IX_BakiInvoiceItems_BakiInvoiceId",
                table: "BakiInvoiceItems",
                column: "BakiInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_BakiInvoices_CustomerId",
                table: "BakiInvoices",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BakiInvoices_InvoiceNumber",
                table: "BakiInvoices",
                column: "InvoiceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BakiInvoices_ShopId",
                table: "BakiInvoices",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_BakiRecords_CustomerId",
                table: "BakiRecords",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BakiRecords_POSTransactionId",
                table: "BakiRecords",
                column: "POSTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_BakiRecords_ShopId",
                table: "BakiRecords",
                column: "ShopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POSTransactions_ShopId",
                table: "POSTransactions",
                column: "ShopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopCustomers_CustomerId",
                table: "ShopCustomers",
                column: "CustomerId");
